...
<div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" method="POST" action="{{route('employees.update',$user->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="row mb-4">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="job" value="{{ old('job',$user->job) }}" id="job_of_user" required class="form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label class="col-md-3 form-label" for="phone_of_user">Phone</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="phone" value="{{ old('phone',$user->phone) }}" id="phone_of_user" required class="form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label class="col-md-3 form-label" for="desc_of_user">Description</label>
                                                <div class="col-md-9">
                                                    <textarea name="description" class="form-control" id="desc_of_user">{{old('dscription',$user->description)}}</textarea>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label class="col-md-3 form-label" for="slide_img">Upload Image</label>
                                                <div class="col-md-9">
                                                    <input id="slide_image" type="file" name="image" class="dropify" accept=".jpg, .png, image/jpeg, image/png" data-default-file="{{asset('uploaded/employees/images/'.$user->image)}}">
