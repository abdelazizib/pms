            ...
            <div class="col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mb-0">Reservations</h3>
                    </div>
                                                                    ...
                                                                    <div class="">
                                                                        <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <p class="mb-0 fs-14 fw-semibold">
                                                                                <a href="tel:{{$rest->phone}}">{{$rest->phone}}</a>
</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td><span class="mt-sm-2 d-block">
                                                                <span class='icon mx-2'><i class="fe fe-users text-black"></i></span>    
                                                                {{$rest->guest}}</span></td>
                                                                <td><span class="mt-sm-2 d-block">{{$rest->date}}</span></td>


                                                                <td>
                                                                    <div class="g-2 d-flex">
                                                                        <a class="btn text-primary btn-sm" href="{{route('reservation.edit',$rest->id)}}" data-bs-toggle="tooltip" data-bs-original-title="Edit"><span class="fe fe-edit fs-14"></span></a>
                                                                        <a class="btn text-primary btn-sm" href="{{route('reservation.show',$rest->id)}}" data-bs-toggle="tooltip" data-bs-original-title="Show"><span class="fe fe-eye fs-14"></span></a>
                                                                        <div class="" data-bs-toggle="tooltip" data-bs-original-title="Delete">
                                                                            <form data-action="{{route('reservation.destroy',$rest->id)}}" class="remove_btn" method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
