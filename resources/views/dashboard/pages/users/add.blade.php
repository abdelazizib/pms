                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" method="POST" action="{{route('users.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="email" value="{{ old('email') }}" id="user_email" required class="form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label class="col-md-3 form-label" for="user_new_phone">Phone</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="phone" value="{{ old('phone') }}" id="user_new_phone" required class="form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label class="col-md-3 form-label" for="user_pass">Password</label>
                                                <div class="col-md-9">
                                        <div class="input-group">

                                        <input type="password" name="password" id="user_pass" autocomplete="new-password" aria-autocomplete="list" required class="form-control">
                                            <a href="#" class="pass_gen text-white input-group-text" id="basic-addon2" data-bs-toggle="modal" data-bs-target="#passGenerate">
