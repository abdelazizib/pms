...
<div class="page-header">
                            <h1 class="page-title">Product - Create</h1>
                            <div>
                                <ol class="breadcrumb">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" method="POST" action="{{route('products.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="name" value="{{ old('name') }}" id="product_name" required class="form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label class="col-md-3 form-label" for="product_price">Price</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="price" value="{{ old('price') }}" id="product_name" required class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="description" class="form-control" id="desc_of_product">{{old('description')}}</textarea>
                                                </div>
                                            </div>
